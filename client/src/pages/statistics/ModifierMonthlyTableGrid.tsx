...
import type { ModifierMonthlyMatrix } from "./table-report-utils";

interface ModifierMonthlyTableGridProps {
  matrix: ModifierMonthlyMatrix;
  year: number;
  month: number;
}
...
export function ModifierMonthlyTableGrid({
  matrix,
  year,
  month,
}: ModifierMonthlyTableGridProps) {
